      ...
      >
        ...
        {!isHome && (
          <div className="mx-auto flex flex-col items-center justify-between pb-6 pt-6 md:max-w-screen-md md:flex-row md:pb-8 md:pt-6 lg:max-w-screen-lg">
            <h1
              className="stroke-2 text-center text-3xl font-bold text-secondary md:text-5xl"
              style={{
                "text-shadow":
                  "1px 1px #311078, 2px 2px #311078, 3px 3px #311078, 4px 4px #311078, 5px 5px #311078, 6px 6px #311078, 7px 7px #311078",
              }}
            >
              {title}
            </h1>
