...
export default function ImageSection({ data }) {
  ...
  return (
    <div
      className={`mx-auto grid grid-cols-1 justify-between gap-6 px-6 md:max-w-screen-lg md:grid-cols-2 md:gap-7 md:px-0`}
    >
      <div
        className={`flex flex-col justify-center ${data.reverse ? "md:order-2" : "md:order-1"}`}
      >
