    ...
    <div className="px-0 md:px-4">
      ...
      >
        <div className="flex flex-col items-center justify-center gap-y-4 bg-contact-bg bg-cover pt-40">
          ...
          <p className="text-xs font-light text-gray-400 md:mt-4 md:text-base">
        ...
        <Image src={dashboard} className="mx-auto mt-6" />
      </div>

      <div className="mx-auto grid max-w-screen-lg grid-cols-1 items-center justify-center md:grid-cols-3 md:flex-row md:py-20">
        {stats.map((item, index) => (
          ...
          >
            <h3 className="text-center text-3xl font-bold text-primary md:text-4xl lg:text-5xl">
              {item.count}
            </h3>
            <h6 className="text-center font-semibold text-gray-900 md:text-xs lg:text-xl">
              {item.title}
            </h6>
          </div>
        ))}
